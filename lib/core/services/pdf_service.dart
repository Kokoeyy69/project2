...
class PdfService {
  ...
  Future<String> generateMonthlyReport({
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Text(
                'IDR ${NumberFormat('#,##0.00').format(total)}',
                style: pw.TextStyle(
                  fontSize: 14,
                  fontWeight: pw.FontWeight.bold,
                ),
        ...
        footer: (context) => pw.Container(
          ...
          child: pw.Text(
            'Generated by NeoPay AI on ${DateFormat('dd/MM/yyyy HH:mm').format(DateTime.now())}',
    ...
    final fileName =
        'neopay_report_${year}_${month.toString().padLeft(2, '0')}.pdf';
  ...
  Future<void> shareReport(String filePath) async {
    await Share.shareXFiles([
      XFile(filePath),
    ], text: 'My NeoPay AI Monthly Report');
  }
}
